...
class QueenMoveFinderTest {

    @Test
    fun should_find_queen_moves_for_white() {
        // given
        val b = Board()
        b.clear()
        b.board[4][4].piece = Queen(Color.WHITE)
        ...
        assertTrue(
            listOf(
                Move(value = "e4f5"), Move(value = "e4g6"), Move(value = "e4h7"), Move(value = "e4d5"),
                Move(value = "e4c6"), Move(value = "e4b7"), Move(value = "e4a8"), Move(value = "e4d3"),
                Move(value = "e4c2"), Move(value = "e4b1"), Move(value = "e4f3"), Move(value = "e4g2"),
                Move(value = "e4h1"), Move(value = "e4e5"), Move(value = "e4e6"), Move(value = "e4e7"),
                Move(value = "e4e8"), Move(value = "e4d4"), Move(value = "e4c4"), Move(value = "e4b4"),
                Move(value = "e4a4"), Move(value = "e4e3"), Move(value = "e4e2"), Move(value = "e4e1"),
                Move(value = "e4f4"), Move(value = "e4g4"), Move(value = "e4h4")
            ).containsAll(moves) && moves.size == 27
        )
    }
